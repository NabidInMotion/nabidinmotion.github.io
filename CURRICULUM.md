...
After you set `STUDY_HUB_DISPATCH_TOKEN` and `STUDY_HUB_REPO=NabidAlam/nabidinmotion` on the curriculum repo, pushes to `main` can trigger an automatic rebuild of the site content.
